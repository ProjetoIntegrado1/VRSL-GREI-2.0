...
| VSBF 06 | Limitar rotação vertical   | **COMO** usuário, **QUERO** limitar a rotação da câmera a 90° para cima e 90° para baixo. **PARA** evitar giros completos de 360° desorientadores.                          | Low      | Done        | 📄 [**MouseLook.cs**](Assets/Standard_Assets/Characters/FirstPersonCharacter/Scripts/MouseLook.cs): refatorado para usar variável de pitch com `Mathf.Clamp(MinimumX, MaximumX)`                                              |
